...
public class DormGardensPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Plant plant1 = new Plant("Ironwood Succulent Planter", "/images/plant1.jpg", price15, medium);
		Plant plant2 = new Plant("Marblewood Succulent Planter", "/images/plant2.jpg", price15, light);
		Plant plant3 = new Plant("African Padauk Succulent Planter", "/images/plant3.jpg", price15, medium);
